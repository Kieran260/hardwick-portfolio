...
const ProjectCardIos: React.FC<ProjectCardProps> = ({ className }) => {
  return (
    <div className={`${className} hover:cursor-pointer hover:bg-white/5 hover:border-white/50 transition-colors flex flex-col bg-background2 border border-white/25 rounded-md min-h-[380px] max-h-[450px] flex-grow justify-start items-start p-4`}>
        ...
        <h2 className="text-sm text-gray-400 pb-2">Algorithmic Delivery Routing System</h2>
