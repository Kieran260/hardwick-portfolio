...
const Hero = () => {
    ...
    return (
        <section
            id="home"
            className={`will-change-auto border-b border-white/20 fade-in-1s flex flex-col items-center w-full h-[105vh] md:h-[100vh] pt-[40px] md:pt-[100px] pb-[200px] relative`}
