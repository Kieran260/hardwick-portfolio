...
const Skills = () => {
  return (
    <section className={`flex flex-col bg-background items-center w-screen ${styles.paddingX}`}>
        ...
        <div className={`${styles.boxWidth} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 w-[1000px] items-center h-[200px] font-normal text-lg`}>
            ...
            <div className={`py-1 my-4 mx-2 rounded-md col-span-1 bg-gradient-to-r from-red-400 at-50 to-orange-400`}>
                <div className={` relative bg-background2 w-full p-4 h-[120px]`}>
