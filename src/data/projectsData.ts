export const beatsbinData = {
    ...
    description: {
        ...
        report: [
            'During summer break during university, I collaborated with two fellow students covering the entire development lifecycle within an Agile framework. As the project lead, I oversaw the phases of design, implementation, testing and team management.',
            ...
            'Our most significant challenge was facilitating large file transfers directly between the S3 bucket and the client, bypassing our server. We overcame this by creating an API which generates a signed URL on our server, enabling direct client-to-S3 uploads and downloads',
